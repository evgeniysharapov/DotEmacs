...
** C/C++
   ...
   #+begin_src emacs-lisp
     (setq ffy-c-headers-location '("/usr/include/c++/4.2.1"
   ...
   #+begin_src emacs-lisp
     (use-package company-c-headers
       ...
       :config (progn
                 ...
                 (dolist (dir (list ffy-c-headers-location))
   ...
   #+begin_src emacs-lisp
     (defun ffy-c-mode-hook ()
       ...
       (when (memq major-mode '(c-mode c++-mode))
         ...
         (message (format "mode-name = %s" major-mode))
         (electric-pair-mode +1)
         (electric-indent-local-mode +1)
         (if electric-indent-mode
             (let ((binding (key-binding (kbd "RET"))))
               ;;  (message (format "Current Map: %s" (current-local-map)))
