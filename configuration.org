...
** Haskell Mode
   ...
   If you use GHC before version 7.8 then a good thiung to add is
   =ghc-mod= and install ghc-mod package =cabal install ghc-mod=
   ...
   #+begin_src emacs-lisp
     (use-package ghc
       ...
       :init (progn
               ...
               ;; remove flymake-mode from the haskell hook
               ))
   #+end_src
